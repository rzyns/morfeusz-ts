...
describe('InterpsGroupsDecoder (placeholder)', () => {
  it('decodes a single group with one interpretation (real format)', () => {
    ...
    const type = CompressionFlags.ORTH_ONLY_LOWER | CompressionFlags.LEMMA_ONLY_LOWER | 0x00;
    ...
    view.setUint16(off, 0x0506, false); off += 2; // tag
    view.setUint8(off++, 0x07); // nameClassifier
    view.setUint16(off, 0x0009, false); off += 2; // qualifiers
